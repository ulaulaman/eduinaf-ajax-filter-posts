...
<?php else: ?>
  <div class="ajax-posts-message ajax-posts-message--empty">
      ...
      <h4><?php printf( __('Non siamo in grado di trovare nessun %s', 'ajax-filter-posts'), $plural_post_name); ?></h4>
      <p><?php printf( __('Prova filtri differenti o <a %s> cancella tutto.</a>', 'ajax-filter-posts'), 'href="#" class="js-reset-filters"'); ?></p>
  </div>
<?php endif; ?>
